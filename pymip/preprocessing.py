...
from pymip.utils import _maybe_make_list, cmip6_dataset_id
...
def correct_units(ds):
    ...
    # See https://github.com/jbusecke/pymip/pull/160#discussion_r667041858
    try:
        # exclude salinity from the quantification (see https://github.com/jbusecke/pymip/pull/160#issuecomment-878627027 for details)
